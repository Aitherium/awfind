...
interesting failures live BETWEEN them. "awfind is installed" is not the useful
fact -- "awfind is installed and the thing it pairs with is not" is. This reports
...
SELF = 'awfind'
FAMILY = ['awask', 'awask', 'awbac', 'awbrowse', 'awdit', 'awevolve', 'awevolve', 'awgit', 'awgraph', 'awiam', 'awkno', 'awm', 'awmail', 'awnboard', 'awnest', 'awnet', 'awnode', 'awpredict', 'awprism', 'awreason', 'awrecover', 'awrecurse', 'awrelay', 'awrepl', 'awresearch', 'awrun', 'awseal', 'awshare', 'awtunnel']
PAIRS_WITH = ['awbrowse', 'adk']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awfind needs at runtime, and a
